    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background p-6">
      <div className="max-w-lg w-full text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Esta parte de la app tuvo un error. El resto de THEOS sigue
          funcionando — tus datos están a salvo en el dispositivo.
        </p>
        {/* Solo en desarrollo: el mensaje puede traer detalles internos. */}
        {import.meta.env.DEV ? (
